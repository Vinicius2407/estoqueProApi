...
export const productTable = pgTable("products", {
    ...
    basePrice: doublePrecision("base_price").notNull().default(0.00),
    categoryId: serial("category_id").notNull().references(() => categoryTable.id, {onDelete: "cascade"}),
...
export const imageProduct = pgTable("image_product", {
    ...
    productId: serial("product_id").notNull().references(() => productTable.id, {onDelete: 'cascade'}),
